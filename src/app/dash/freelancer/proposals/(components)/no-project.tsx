export function NoProjectFound() {
    return (
        <div className=' rounded-lg p-10 text-center flex flex-col items-center mt-5'>
            ...
            <h3 className='text-xl font-semibold text-gray-800 mb-2'>
                Nenhum projecto foi Encontrado
            </h3>
            <p className='text-gray-600 max-w-lg mb-6'>
                Quando houver, as iformações dos projetos serão exibidas aqui
            </p>
        </div>
    );
}
