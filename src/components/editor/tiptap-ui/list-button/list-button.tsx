...
export function toggleList(editor: Editor | null, type: ListType): void {
    ...
    // Store the current heading level if any
    ...
    // If heading was active and list is now active, reapply heading to list items
    if (
        currentHeadingLevel &&
        ...
        editor.chain().focus().setHeading({ level: currentHeadingLevel }).run();
    }
}
