...
type FreelancerByEmail = {
    status: "error" | "success";
    message: string;
    data?: EntityProps;
};

export async function getFreelancerByEmail(
    email: string
): Promise<FreelancerByEmail> {
